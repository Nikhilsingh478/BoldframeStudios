  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className={`staggered-menu-header fixed top-0 left-0 w-full flex items-center justify-between transition-all duration-300 pointer-events-none z-20 ${
            scrolled && !open
              ? 'glass-header py-[1em] px-[2.5em]' 
              : 'py-[1.8em] px-[2.5em] bg-transparent'
          }`}
...
/* Glass sticky header styling */
.sm-scope .glass-header {
  background: rgba(11, 13, 15, 0.75) !important;
  backdrop-filter: blur(16px) !important;
  -webkit-backdrop-filter: blur(16px) !important;
  border-bottom: 1px solid rgba(124, 138, 150, 0.08);
}
.sm-scope .staggered-menu-wrapper[data-open] .glass-header {
