import{r as d,j as e}from"./radix-D4tmaoiR.js";import{m as f}from"./index-BhuLfGQX.js";import"./react-D3F3s8fL.js";import"./motion-B42wbOFf.js";import"./vendor-CyKTmFfE.js";function j({onContactClick:p,onPrivacyClick:i,onTermsClick:t}){const[s,a]=d.useState(!1),[n,l]=d.useState(""),r=(o,h)=>{o.preventDefault();const c=document.getElementById(h);c&&c.scrollIntoView({behavior:"smooth"})},x=o=>{o.preventDefault(),n.trim()&&(a(!0),l(""),setTimeout(()=>a(!1),3e3))};return e.jsxs("section",{className:"footer-section",children:[e.jsx("style",{children:`
        .footer-section {
          background: #0B0D0F;
