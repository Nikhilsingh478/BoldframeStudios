import{r as a,j as e}from"./radix-D4tmaoiR.js";import{m as l}from"./index-WX0V30W-.js";import"./react-D3F3s8fL.js";import"./motion-4O9EsY6r.js";import"./vendor-CazOkfzf.js";function N({onContactClick:c,onPrivacyClick:d,onTermsClick:p}){const x=a.useRef(null),f=a.useRef(null),[s,h]=a.useState(!1),[m,g]=a.useState("");a.useLayoutEffect(()=>{function t(){const i=f.current,u=x.current;if(!(!i||!u))try{const r=u.getBBox();i.setAttribute("viewBox",`${r.x} ${r.y} ${r.width} ${r.height}`)}catch{}}document.fonts&&document.fonts.ready?document.fonts.ready.then(t):window.addEventListener("load",t),window.addEventListener("resize",t),t();const n=setTimeout(t,100);return()=>{window.removeEventListener("load",t),window.removeEventListener("resize",t),clearTimeout(n)}},[]);const o=(t,n)=>{t.preventDefault();const i=document.getElementById(n);i&&i.scrollIntoView({behavior:"smooth"})},w=t=>{t.preventDefault(),m.trim()&&(h(!0),g(""),setTimeout(()=>h(!1),3e3))};return e.jsxs("section",{className:"footer-section",children:[e.jsx("style",{children:`
        .footer-section {
          background: #0B0D0F;
