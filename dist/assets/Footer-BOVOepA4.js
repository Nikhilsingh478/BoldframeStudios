import{r as a,j as e}from"./radix-D4tmaoiR.js";import"./react-D3F3s8fL.js";function v({onContactClick:l,onPrivacyClick:c,onTermsClick:d}){const p=a.useRef(null),x=a.useRef(null),[s,f]=a.useState(!1),[h,m]=a.useState("");a.useLayoutEffect(()=>{function o(){const r=x.current,g=p.current;if(!(!r||!g))try{const i=g.getBBox();r.setAttribute("viewBox",`${i.x} ${i.y} ${i.width} ${i.height}`)}catch{}}document.fonts&&document.fonts.ready?document.fonts.ready.then(o):window.addEventListener("load",o),window.addEventListener("resize",o),o();const n=setTimeout(o,100);return()=>{window.removeEventListener("load",o),window.removeEventListener("resize",o),clearTimeout(n)}},[]);const t=(o,n)=>{o.preventDefault();const r=document.getElementById(n);r&&r.scrollIntoView({behavior:"smooth"})},u=o=>{o.preventDefault(),h.trim()&&(f(!0),m(""),setTimeout(()=>f(!1),3e3))};return e.jsxs("section",{className:"footer-section",children:[e.jsx("style",{children:`
        .footer-section {
          background: #0B0D0F;
